...
with open(basepath+'Hue_40.736516_-74.0075864066_40.7628541651_-73.9656092319.csv', 'w') as csvfile:
    ...
    for file in currentdir:
       ...
       # print lat, lng
        total = group1+group2+group3+group4+group5+group0
        imagedata = [group0, group1,group2,group3,group4,group5, total, lat, lng]
        print imagedata
